...
public class QnaServiceImpl implements QnaService {
	...
	public QnaBaseRes qnaRegister(QnaRegisterReq qnaRegisterReq){
		...
		Long qnaId=qnaRepository.findFirstByOrderByIdDesc().orElseThrow(QnaNotFoundException::new).getQnaId();
		...
		alarmService.sendList(adminEmailList,qna.getTitle()+", QnA가 등록되었습니다.", "/qna/"+qnaId);
